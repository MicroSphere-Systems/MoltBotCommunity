...
export default async function ClawdbotArticlePage({ params }: PageProps) {
  const { slug } = await params
  const supabase = await createClient()
  ...
  return (
    <article className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <header className="mb-8">
        <Badge variant="outline" className="mb-4 bg-purple-500/10 text-purple-500 border-purple-500/20">
          ClawdBot
        </Badge>
